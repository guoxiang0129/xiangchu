...
<div id="cook-page">
    <alllist>
        ...
        <div class="panel" :style="panel" id="panel1" v-show="hidden1">
            <div class="page-cook-md">
                <dl v-for="item in cooktype" :key="item">
                    <dt class="clear-header">{{item.list}}<a name="#5"></a></dt>
                    <dd class="clearfix">
                        <ul>
        ...
        <div class="pane1" :style="panel2" v-show="hidden2">
            <div class="page-cook-md">
    ...
    methods: {
        ...
        toPosition:function(){
            ...
            switch(this.index){
                ...
                case 1 :
                    this.top = -7.5;
                    this.panel = 'top:-7.5rem';
                    break;
                case 2 :
                    this.top = -14.8;
                    this.panel = 'top:-14.8rem';
                    break;
                case 3 :
                    this.top = -21.8;
                    this.panel = 'top:-21.8rem';
                    break;
                case 4 :
                    this.top = -28.8;
                    this.panel = 'top:-28.8rem';
                    break;
                case 5:
                    // document.getElementById('#cook-page').scrollTop = 300;
                    this.top = -35.5;
                    this.panel = 'top:-35.5rem';
                    break;
            }
        }
    },
