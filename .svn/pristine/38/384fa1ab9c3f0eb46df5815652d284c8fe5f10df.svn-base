    ...
    <div class="home-page">
        ...
        <div class="home-header">
            ...
            <div class="home-header-search">
                <div>
                    <div class="placeholder" @click="souSuo">
            ...
            <div class="home-header-right">
                <router-link to="/login"><img class="home-header-img" src="http://img.szzhangchu.com/1445429526387_9171386134.jpg@48h_48w_1e_1c.jpg"></router-link>
            </div>
        </div>
        ...
        <ul class="home-nav home-nav-one">
            ...
            <router-link tag="li" :to="{name:'Food',params:{id:0}}" class="nav-item">
            美食
            </router-link>
             <router-link tag="li" :to="{name:'Food',params:{id:1}}" class="nav-item">
            健康
            </router-link>
            <router-link tag="li" :to="{name:'Cook',params:{type:'食材',index:0}}" class="nav-item">
            食材
            </router-link>
            <router-link tag="li" :to="{name:'Cook',params:{type:'菜谱',index:0}}" class="nav-item">
            万道佳肴
            </router-link>
         </ul>
        ...
        <ul class="list-type-three">
            <li class="list-type-three-item" v-for="(item,i) in lists.foodlists" :key="item.id">
                <router-link :to="{name:'Cook',params:{type:'菜谱',index:i}}" class="list-type-three-A">
                    <img :src="item.img">
                    <span>{{item.name}}</span>
                </router-link>
            </li>
